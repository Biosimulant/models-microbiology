...
"""Auto-generated SBML BioModule wrapper for DiVentura2011_Min_System_E_coli.

Source: biomodels_ebi:MODEL1101180000
Original: https://www.ebi.ac.uk/biomodels/MODEL1101180000
"""
...
class SbmlDiventura2011MinSystemEColi(biosim.BioModule):
    """BioModule wrapper for SBML model: DiVentura2011_Min_System_E_coli."""

    def __init__(self, model_path: str = "data/MODEL1101180000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Diventura2011MinSystemEColiModel1101180000Model = SbmlDiventura2011MinSystemEColi
