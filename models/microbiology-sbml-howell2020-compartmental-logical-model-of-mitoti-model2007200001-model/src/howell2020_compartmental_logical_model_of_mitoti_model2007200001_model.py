...
"""Auto-generated SBML BioModule wrapper for Howell2020- Compartmental Logical model of mitotic exit.

Source: biomodels_ebi:MODEL2007200001
Original: https://www.ebi.ac.uk/biomodels/MODEL2007200001
"""
...
class SbmlHowell2020CompartmentalLogicalModelOfMitoticExit(biosim.BioModule):
    """BioModule wrapper for SBML model: Howell2020- Compartmental Logical model of mitotic exit."""

    def __init__(self, model_path: str = "data/MODEL2007200001.sbml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Howell2020CompartmentalLogicalModelOfMitotiModel2007200001Model = SbmlHowell2020CompartmentalLogicalModelOfMitoticExit
