...
"""Auto-generated SBML BioModule wrapper for Khan2022 - QcrB Inhibition Prediction with Machine Learning Protocol.

Source: biomodels_ebi:MODEL2405080004
Original: https://www.ebi.ac.uk/biomodels/MODEL2405080004
"""
...
class SbmlKhan2022QcrbInhibitionPredictionWithMachineLearning(biosim.BioModule):
    """BioModule wrapper for SBML model: Khan2022 - QcrB Inhibition Prediction with Machine Learning Protocol."""

    def __init__(self, model_path: str = "data/MODEL2405080004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Khan2022QcrbInhibitionPredictionWithMachineModel2405080004Model = SbmlKhan2022QcrbInhibitionPredictionWithMachineLearning
