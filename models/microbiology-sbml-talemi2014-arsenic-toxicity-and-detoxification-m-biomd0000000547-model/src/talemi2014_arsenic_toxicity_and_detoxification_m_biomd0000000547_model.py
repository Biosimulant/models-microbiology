...
"""Auto-generated SBML BioModule wrapper for Talemi2014 - Arsenic toxicity and detoxification mechanisms in yeast.

Source: biomodels_ebi:BIOMD0000000547
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000547
"""
...
class SbmlTalemi2014ArsenicToxicityAndDetoxificationMechanisms(biosim.BioModule):
    """BioModule wrapper for SBML model: Talemi2014 - Arsenic toxicity and detoxification mechanisms in yeast."""

    def __init__(self, model_path: str = "data/BIOMD0000000547.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Talemi2014ArsenicToxicityAndDetoxificationMBiomd0000000547Model = SbmlTalemi2014ArsenicToxicityAndDetoxificationMechanisms
