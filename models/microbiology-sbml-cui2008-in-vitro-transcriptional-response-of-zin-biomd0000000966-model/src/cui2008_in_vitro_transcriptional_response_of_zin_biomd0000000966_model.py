...
"""Auto-generated SBML BioModule wrapper for Cui2008 - in vitro transcriptional response of zinc homeostasis system in Escherichia coli.

Source: biomodels_ebi:BIOMD0000000966
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000966
"""
...
class SbmlCui2008InVitroTranscriptionalResponseOfZinc(biosim.BioModule):
    """BioModule wrapper for SBML model: Cui2008 - in vitro transcriptional response of zinc homeostasis system in Escherichia coli."""

    def __init__(self, model_path: str = "data/BIOMD0000000966.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cui2008InVitroTranscriptionalResponseOfZinBiomd0000000966Model = SbmlCui2008InVitroTranscriptionalResponseOfZinc
