...
"""Auto-generated SBML BioModule wrapper for Pritchard2014 - plant-microbe interaction.

Source: biomodels_ebi:BIOMD0000000563
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000563
"""
...
class SbmlPritchard2014PlantMicrobeInteraction(biosim.BioModule):
    """BioModule wrapper for SBML model: Pritchard2014 - plant-microbe interaction."""

    def __init__(self, model_path: str = "data/BIOMD0000000563.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pritchard2014PlantMicrobeInteractionBiomd0000000563Model = SbmlPritchard2014PlantMicrobeInteraction
