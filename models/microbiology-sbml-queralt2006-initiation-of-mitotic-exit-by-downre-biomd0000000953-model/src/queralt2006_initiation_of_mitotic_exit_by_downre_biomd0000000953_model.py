...
"""Auto-generated SBML BioModule wrapper for Queralt2006 - Initiation of mitotic exit by downregulation of PP2A in budding yeast.

Source: biomodels_ebi:BIOMD0000000953
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000953
"""
...
class SbmlQueralt2006InitiationOfMitoticExitByDownregulationOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Queralt2006 - Initiation of mitotic exit by downregulation of PP2A in budding yeast."""

    def __init__(self, model_path: str = "data/BIOMD0000000953.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Queralt2006InitiationOfMitoticExitByDownreBiomd0000000953Model = SbmlQueralt2006InitiationOfMitoticExitByDownregulationOf
