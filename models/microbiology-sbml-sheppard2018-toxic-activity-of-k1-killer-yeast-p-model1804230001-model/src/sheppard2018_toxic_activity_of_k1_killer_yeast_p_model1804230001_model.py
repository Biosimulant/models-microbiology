...
"""Auto-generated SBML BioModule wrapper for Sheppard2018 - Toxic Activity of K1 Killer Yeast Protein.

Source: biomodels_ebi:MODEL1804230001
Original: https://www.ebi.ac.uk/biomodels/MODEL1804230001
"""
...
class SbmlSheppard2018ToxicActivityOfK1KillerYeastProtein(biosim.BioModule):
    """BioModule wrapper for SBML model: Sheppard2018 - Toxic Activity of K1 Killer Yeast Protein."""

    def __init__(self, model_path: str = "data/MODEL1804230001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sheppard2018ToxicActivityOfK1KillerYeastPModel1804230001Model = SbmlSheppard2018ToxicActivityOfK1KillerYeastProtein
