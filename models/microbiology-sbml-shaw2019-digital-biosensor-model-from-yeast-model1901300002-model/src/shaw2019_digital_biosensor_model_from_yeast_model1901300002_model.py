...
"""Auto-generated SBML BioModule wrapper for Shaw2019 - Digital biosensor model from Yeast.

Source: biomodels_ebi:MODEL1901300002
Original: https://www.ebi.ac.uk/biomodels/MODEL1901300002
"""
...
class SbmlShaw2019DigitalBiosensorModelFromYeast(biosim.BioModule):
    """BioModule wrapper for SBML model: Shaw2019 - Digital biosensor model from Yeast."""

    def __init__(self, model_path: str = "data/MODEL1901300002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Shaw2019DigitalBiosensorModelFromYeastModel1901300002Model = SbmlShaw2019DigitalBiosensorModelFromYeast
