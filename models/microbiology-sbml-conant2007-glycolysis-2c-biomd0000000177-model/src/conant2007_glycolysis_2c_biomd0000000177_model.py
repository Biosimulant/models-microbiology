...
"""Auto-generated SBML BioModule wrapper for Conant2007_glycolysis_2C.

Source: biomodels_ebi:BIOMD0000000177
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000177
"""
...
class SbmlConant2007Glycolysis2c(biosim.BioModule):
    """BioModule wrapper for SBML model: Conant2007_glycolysis_2C."""

    def __init__(self, model_path: str = "data/BIOMD0000000177.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Conant2007Glycolysis2cBiomd0000000177Model = SbmlConant2007Glycolysis2c
