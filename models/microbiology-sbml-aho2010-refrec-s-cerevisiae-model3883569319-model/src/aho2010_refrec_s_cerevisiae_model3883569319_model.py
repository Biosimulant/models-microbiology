...
"""Auto-generated SBML BioModule wrapper for Aho2010_RefRec_S_cerevisiae.

Source: biomodels_ebi:MODEL3883569319
Original: https://www.ebi.ac.uk/biomodels/MODEL3883569319
"""
...
class SbmlAho2010RefrecSCerevisiae(biosim.BioModule):
    """BioModule wrapper for SBML model: Aho2010_RefRec_S_cerevisiae."""

    def __init__(self, model_path: str = "data/MODEL3883569319.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Aho2010RefrecSCerevisiaeModel3883569319Model = SbmlAho2010RefrecSCerevisiae
