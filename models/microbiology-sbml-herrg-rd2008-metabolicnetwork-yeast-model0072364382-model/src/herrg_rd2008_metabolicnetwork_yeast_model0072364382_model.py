...
"""Auto-generated SBML BioModule wrapper for Herrgård2008_MetabolicNetwork_Yeast.

Source: biomodels_ebi:MODEL0072364382
Original: https://www.ebi.ac.uk/biomodels/MODEL0072364382
"""
...
class SbmlHerrgard2008MetabolicnetworkYeast(biosim.BioModule):
    """BioModule wrapper for SBML model: Herrgård2008_MetabolicNetwork_Yeast."""

    def __init__(self, model_path: str = "data/MODEL0072364382.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
HerrgRd2008MetabolicnetworkYeastModel0072364382Model = SbmlHerrgard2008MetabolicnetworkYeast
