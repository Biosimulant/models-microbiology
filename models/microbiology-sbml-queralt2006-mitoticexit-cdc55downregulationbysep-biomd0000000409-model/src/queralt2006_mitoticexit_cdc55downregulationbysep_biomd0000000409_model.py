...
"""Auto-generated SBML BioModule wrapper for Queralt2006_MitoticExit_Cdc55DownregulationBySeparase.

Source: biomodels_ebi:BIOMD0000000409
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000409
"""
...
class SbmlQueralt2006MitoticexitCdc55downregulationbyseparase(biosim.BioModule):
    """BioModule wrapper for SBML model: Queralt2006_MitoticExit_Cdc55DownregulationBySeparase."""

    def __init__(self, model_path: str = "data/BIOMD0000000409.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Queralt2006MitoticexitCdc55downregulationbysepBiomd0000000409Model = SbmlQueralt2006MitoticexitCdc55downregulationbyseparase
