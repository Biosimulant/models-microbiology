...
"""Auto-generated SBML BioModule wrapper for Budding yeast size control by titration of nuclear sites.

Source: biomodels_ebi:BIOMD0000000856
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000856
"""
...
class SbmlBuddingYeastSizeControlByTitrationOfNuclearSites(biosim.BioModule):
    """BioModule wrapper for SBML model: Budding yeast size control by titration of nuclear sites."""

    def __init__(self, model_path: str = "data/BIOMD0000000856.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BuddingYeastSizeControlByTitrationOfNucleBiomd0000000856Model = SbmlBuddingYeastSizeControlByTitrationOfNuclearSites
