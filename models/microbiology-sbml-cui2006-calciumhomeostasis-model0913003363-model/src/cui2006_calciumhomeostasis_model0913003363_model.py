...
"""Auto-generated SBML BioModule wrapper for Cui2006_CalciumHomeostasis.

Source: biomodels_ebi:MODEL0913003363
Original: https://www.ebi.ac.uk/biomodels/MODEL0913003363
"""
...
class SbmlCui2006Calciumhomeostasis(biosim.BioModule):
    """BioModule wrapper for SBML model: Cui2006_CalciumHomeostasis."""

    def __init__(self, model_path: str = "data/MODEL0913003363.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cui2006CalciumhomeostasisModel0913003363Model = SbmlCui2006Calciumhomeostasis
