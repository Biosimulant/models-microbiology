...
"""Auto-generated SBML BioModule wrapper for iJD1249 - Pseudomonas aeruginosa PAO1.

Source: biomodels_ebi:MODEL2504040001
Original: https://www.ebi.ac.uk/biomodels/MODEL2504040001
"""
...
class SbmlIjd1249PseudomonasAeruginosaPao1(biosim.BioModule):
    """BioModule wrapper for SBML model: iJD1249 - Pseudomonas aeruginosa PAO1."""

    def __init__(self, model_path: str = "data/MODEL2504040001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ijd1249PseudomonasAeruginosaPao1Model2504040001Model = SbmlIjd1249PseudomonasAeruginosaPao1
