...
"""Auto-generated SBML BioModule wrapper for Houser2012_pheromone_Ste12.

Source: biomodels_ebi:MODEL1204040000
Original: https://www.ebi.ac.uk/biomodels/MODEL1204040000
"""
...
class SbmlHouser2012PheromoneSte12(biosim.BioModule):
    """BioModule wrapper for SBML model: Houser2012_pheromone_Ste12."""

    def __init__(self, model_path: str = "data/MODEL1204040000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Houser2012PheromoneSte12Model1204040000Model = SbmlHouser2012PheromoneSte12
