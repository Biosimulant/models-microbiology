...
"""Auto-generated SBML BioModule wrapper for Kuwahara2010_Fimbriation_Switch_42C.

Source: biomodels_ebi:MODEL1004010002
Original: https://www.ebi.ac.uk/biomodels/MODEL1004010002
"""
...
class SbmlKuwahara2010FimbriationSwitch42c(biosim.BioModule):
    """BioModule wrapper for SBML model: Kuwahara2010_Fimbriation_Switch_42C."""

    def __init__(self, model_path: str = "data/MODEL1004010002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kuwahara2010FimbriationSwitch42cModel1004010002Model = SbmlKuwahara2010FimbriationSwitch42c
