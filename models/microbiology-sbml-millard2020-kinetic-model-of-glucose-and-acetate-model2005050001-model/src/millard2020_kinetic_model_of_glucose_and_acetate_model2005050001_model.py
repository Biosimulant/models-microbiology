...
"""Auto-generated SBML BioModule wrapper for Millard2020 - Kinetic model of Glucose and Acetate metabolisms in E. coli.

Source: biomodels_ebi:MODEL2005050001
Original: https://www.ebi.ac.uk/biomodels/MODEL2005050001
"""
...
class SbmlMillard2020KineticModelOfGlucoseAndAcetate(biosim.BioModule):
    """BioModule wrapper for SBML model: Millard2020 - Kinetic model of Glucose and Acetate metabolisms in E. coli."""

    def __init__(self, model_path: str = "data/MODEL2005050001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Millard2020KineticModelOfGlucoseAndAcetateModel2005050001Model = SbmlMillard2020KineticModelOfGlucoseAndAcetate
