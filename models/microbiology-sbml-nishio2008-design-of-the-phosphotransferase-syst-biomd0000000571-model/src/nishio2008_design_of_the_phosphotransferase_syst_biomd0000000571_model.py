...
"""Auto-generated SBML BioModule wrapper for Nishio2008 - Design of the phosphotransferase system for enhanced glucose uptake in E. coli..

Source: biomodels_ebi:BIOMD0000000571
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000571
"""
...
class SbmlNishio2008DesignOfThePhosphotransferaseSystemFor(biosim.BioModule):
    """BioModule wrapper for SBML model: Nishio2008 - Design of the phosphotransferase system for enhanced glucose uptake in E. coli.."""

    def __init__(self, model_path: str = "data/BIOMD0000000571.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nishio2008DesignOfThePhosphotransferaseSystBiomd0000000571Model = SbmlNishio2008DesignOfThePhosphotransferaseSystemFor
