...
"""Auto-generated SBML BioModule wrapper for Gardner2000 - genetic toggle switch in E.coli.

Source: biomodels_ebi:BIOMD0000000507
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000507
"""
...
class SbmlGardner2000GeneticToggleSwitchInEColi(biosim.BioModule):
    """BioModule wrapper for SBML model: Gardner2000 - genetic toggle switch in E.coli."""

    def __init__(self, model_path: str = "data/BIOMD0000000507.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gardner2000GeneticToggleSwitchInEColiBiomd0000000507Model = SbmlGardner2000GeneticToggleSwitchInEColi
