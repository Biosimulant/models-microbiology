...
"""Auto-generated SBML BioModule wrapper for Smith2016-Combination therapy to prevent bacterial coinfection during influenza..

Source: biomodels_ebi:MODEL1812040005
Original: https://www.ebi.ac.uk/biomodels/MODEL1812040005
"""
...
class SbmlSmith2016CombinationTherapyToPreventBacterial(biosim.BioModule):
    """BioModule wrapper for SBML model: Smith2016-Combination therapy to prevent bacterial coinfection during influenza.."""

    def __init__(self, model_path: str = "data/MODEL1812040005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smith2016CombinationTherapyToPreventBacteriModel1812040005Model = SbmlSmith2016CombinationTherapyToPreventBacterial
