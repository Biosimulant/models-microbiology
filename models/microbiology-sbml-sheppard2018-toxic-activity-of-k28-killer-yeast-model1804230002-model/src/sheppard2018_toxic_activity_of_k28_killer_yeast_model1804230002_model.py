...
"""Auto-generated SBML BioModule wrapper for Sheppard2018 - Toxic Activity of K28 Killer Yeast Protein.

Source: biomodels_ebi:MODEL1804230002
Original: https://www.ebi.ac.uk/biomodels/MODEL1804230002
"""
...
class SbmlSheppard2018ToxicActivityOfK28KillerYeastProtein(biosim.BioModule):
    """BioModule wrapper for SBML model: Sheppard2018 - Toxic Activity of K28 Killer Yeast Protein."""

    def __init__(self, model_path: str = "data/MODEL1804230002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sheppard2018ToxicActivityOfK28KillerYeastModel1804230002Model = SbmlSheppard2018ToxicActivityOfK28KillerYeastProtein
