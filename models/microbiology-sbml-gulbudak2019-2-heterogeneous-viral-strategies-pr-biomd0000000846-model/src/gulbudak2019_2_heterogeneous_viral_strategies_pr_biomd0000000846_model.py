...
"""Auto-generated SBML BioModule wrapper for Gulbudak2019.2 - Heterogeneous viral strategies promote coexistence in virus-microbe systems (Chronic).

Source: biomodels_ebi:BIOMD0000000846
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000846
"""
...
class SbmlGulbudak20192HeterogeneousViralStrategiesPromote(biosim.BioModule):
    """BioModule wrapper for SBML model: Gulbudak2019.2 - Heterogeneous viral strategies promote coexistence in virus-microbe systems (Chronic)."""

    def __init__(self, model_path: str = "data/BIOMD0000000846.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gulbudak20192HeterogeneousViralStrategiesPrBiomd0000000846Model = SbmlGulbudak20192HeterogeneousViralStrategiesPromote
