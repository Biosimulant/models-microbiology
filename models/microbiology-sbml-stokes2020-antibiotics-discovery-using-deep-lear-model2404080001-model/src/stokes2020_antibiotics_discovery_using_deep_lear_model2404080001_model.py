...
"""Auto-generated SBML BioModule wrapper for Stokes2020 - Antibiotics discovery using deep learning approach..

Source: biomodels_ebi:MODEL2404080001
Original: https://www.ebi.ac.uk/biomodels/MODEL2404080001
"""
...
class SbmlStokes2020AntibioticsDiscoveryUsingDeepLearning2(biosim.BioModule):
    """BioModule wrapper for SBML model: Stokes2020 - Antibiotics discovery using deep learning approach.."""

    def __init__(self, model_path: str = "data/MODEL2404080001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Stokes2020AntibioticsDiscoveryUsingDeepLearModel2404080001Model = SbmlStokes2020AntibioticsDiscoveryUsingDeepLearning2
