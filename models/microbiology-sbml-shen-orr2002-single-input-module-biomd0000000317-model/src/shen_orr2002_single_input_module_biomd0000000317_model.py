...
"""Auto-generated SBML BioModule wrapper for Shen-Orr2002_Single_Input_Module.

Source: biomodels_ebi:BIOMD0000000317
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000317
"""
...
class SbmlShenOrr2002SingleInputModule(biosim.BioModule):
    """BioModule wrapper for SBML model: Shen-Orr2002_Single_Input_Module."""

    def __init__(self, model_path: str = "data/BIOMD0000000317.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ShenOrr2002SingleInputModuleBiomd0000000317Model = SbmlShenOrr2002SingleInputModule
