...
"""Auto-generated SBML BioModule wrapper for Konstantinidis2021 - Persistence of mutants in a mutualistic microbial co-culture.

Source: biomodels_ebi:MODEL2106100001
Original: https://www.ebi.ac.uk/biomodels/MODEL2106100001
"""
...
class SbmlKonstantinidis2021PersistenceOfMutantsInAMutualistic(biosim.BioModule):
    """BioModule wrapper for SBML model: Konstantinidis2021 - Persistence of mutants in a mutualistic microbial co-culture."""

    def __init__(self, model_path: str = "data/MODEL2106100001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Konstantinidis2021PersistenceOfMutantsInAMModel2106100001Model = SbmlKonstantinidis2021PersistenceOfMutantsInAMutualistic
