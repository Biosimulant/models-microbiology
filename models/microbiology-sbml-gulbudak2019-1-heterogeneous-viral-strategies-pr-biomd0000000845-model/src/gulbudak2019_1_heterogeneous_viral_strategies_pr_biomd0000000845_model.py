...
"""Auto-generated SBML BioModule wrapper for Gulbudak2019.1 - Heterogeneous viral strategies promote coexistence in virus-microbe systems (Lytic).

Source: biomodels_ebi:BIOMD0000000845
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000845
"""
...
class SbmlGulbudak20191HeterogeneousViralStrategiesPromote(biosim.BioModule):
    """BioModule wrapper for SBML model: Gulbudak2019.1 - Heterogeneous viral strategies promote coexistence in virus-microbe systems (Lytic)."""

    def __init__(self, model_path: str = "data/BIOMD0000000845.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gulbudak20191HeterogeneousViralStrategiesPrBiomd0000000845Model = SbmlGulbudak20191HeterogeneousViralStrategiesPromote
