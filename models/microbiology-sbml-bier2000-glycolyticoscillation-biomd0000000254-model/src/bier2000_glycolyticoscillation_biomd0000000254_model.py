...
"""Auto-generated SBML BioModule wrapper for Bier2000_GlycolyticOscillation.

Source: biomodels_ebi:BIOMD0000000254
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000254
"""
...
class SbmlBier2000Glycolyticoscillation(biosim.BioModule):
    """BioModule wrapper for SBML model: Bier2000_GlycolyticOscillation."""

    def __init__(self, model_path: str = "data/BIOMD0000000254.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bier2000GlycolyticoscillationBiomd0000000254Model = SbmlBier2000Glycolyticoscillation
