...
"""Auto-generated SBML BioModule wrapper for Poudel2020 - maltose_model.

Source: biomodels_ebi:MODEL2005290001
Original: https://www.ebi.ac.uk/biomodels/MODEL2005290001
"""
...
class SbmlPoudel2020MaltoseModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Poudel2020 - maltose_model."""

    def __init__(self, model_path: str = "data/MODEL2005290001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Poudel2020MaltoseModelModel2005290001Model = SbmlPoudel2020MaltoseModel
