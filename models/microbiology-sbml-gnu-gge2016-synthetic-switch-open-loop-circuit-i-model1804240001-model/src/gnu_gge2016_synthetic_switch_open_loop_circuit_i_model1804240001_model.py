...
"""Auto-generated SBML BioModule wrapper for Gnügge2016 - Synthetic switch Open loop circuit in yeast.

Source: biomodels_ebi:MODEL1804240001
Original: https://www.ebi.ac.uk/biomodels/MODEL1804240001
"""
...
class SbmlGnugge2016SyntheticSwitchOpenLoopCircuitInYeast(biosim.BioModule):
    """BioModule wrapper for SBML model: Gnügge2016 - Synthetic switch Open loop circuit in yeast."""

    def __init__(self, model_path: str = "data/MODEL1804240001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
GnuGge2016SyntheticSwitchOpenLoopCircuitIModel1804240001Model = SbmlGnugge2016SyntheticSwitchOpenLoopCircuitInYeast
