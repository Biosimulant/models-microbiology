...
"""Auto-generated SBML BioModule wrapper for Feierabend2021 - iCGB21FR - GEM of Corynebacterium glutamicum ATCC 13032 (Bielefeld).

Source: biomodels_ebi:MODEL2102050001
Original: https://www.ebi.ac.uk/biomodels/MODEL2102050001
"""
...
class SbmlFeierabend2021Icgb21frGemOfCorynebacteriumGlutamicum(biosim.BioModule):
    """BioModule wrapper for SBML model: Feierabend2021 - iCGB21FR - GEM of Corynebacterium glutamicum ATCC 13032 (Bielefeld)."""

    def __init__(self, model_path: str = "data/MODEL2102050001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Feierabend2021Icgb21frGemOfCorynebacteriumGModel2102050001Model = SbmlFeierabend2021Icgb21frGemOfCorynebacteriumGlutamicum
