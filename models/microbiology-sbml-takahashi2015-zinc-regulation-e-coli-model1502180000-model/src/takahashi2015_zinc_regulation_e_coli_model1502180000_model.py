...
"""Auto-generated SBML BioModule wrapper for Takahashi2015 - Zinc regulation E.coli.

Source: biomodels_ebi:MODEL1502180000
Original: https://www.ebi.ac.uk/biomodels/MODEL1502180000
"""
...
class SbmlTakahashi2015ZincRegulationEColi(biosim.BioModule):
    """BioModule wrapper for SBML model: Takahashi2015 - Zinc regulation E.coli."""

    def __init__(self, model_path: str = "data/MODEL1502180000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Takahashi2015ZincRegulationEColiModel1502180000Model = SbmlTakahashi2015ZincRegulationEColi
