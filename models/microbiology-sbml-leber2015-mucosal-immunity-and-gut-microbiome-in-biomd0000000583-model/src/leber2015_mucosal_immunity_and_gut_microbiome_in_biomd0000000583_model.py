...
"""Auto-generated SBML BioModule wrapper for Leber2015 - Mucosal immunity and gut microbiome interaction during C. difficile infection.

Source: biomodels_ebi:BIOMD0000000583
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000583
"""
...
class SbmlLeber2015MucosalImmunityAndGutMicrobiomeInteraction(biosim.BioModule):
    """BioModule wrapper for SBML model: Leber2015 - Mucosal immunity and gut microbiome interaction during C. difficile infection."""

    def __init__(self, model_path: str = "data/BIOMD0000000583.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Leber2015MucosalImmunityAndGutMicrobiomeInBiomd0000000583Model = SbmlLeber2015MucosalImmunityAndGutMicrobiomeInteraction
