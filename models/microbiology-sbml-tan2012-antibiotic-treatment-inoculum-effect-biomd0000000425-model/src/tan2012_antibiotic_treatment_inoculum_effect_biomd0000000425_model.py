...
"""Auto-generated SBML BioModule wrapper for Tan2012 - Antibiotic Treatment, Inoculum Effect.

Source: biomodels_ebi:BIOMD0000000425
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000425
"""
...
class SbmlTan2012AntibioticTreatmentInoculumEffect(biosim.BioModule):
    """BioModule wrapper for SBML model: Tan2012 - Antibiotic Treatment, Inoculum Effect."""

    def __init__(self, model_path: str = "data/BIOMD0000000425.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tan2012AntibioticTreatmentInoculumEffectBiomd0000000425Model = SbmlTan2012AntibioticTreatmentInoculumEffect
