...
"""Auto-generated SBML BioModule wrapper for Schuetz2007_ecoli_FBA.

Source: biomodels_ebi:MODEL4665428627
Original: https://www.ebi.ac.uk/biomodels/MODEL4665428627
"""
...
class SbmlSchuetz2007EcoliFba(biosim.BioModule):
    """BioModule wrapper for SBML model: Schuetz2007_ecoli_FBA."""

    def __init__(self, model_path: str = "data/MODEL4665428627.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Schuetz2007EcoliFbaModel4665428627Model = SbmlSchuetz2007EcoliFba
