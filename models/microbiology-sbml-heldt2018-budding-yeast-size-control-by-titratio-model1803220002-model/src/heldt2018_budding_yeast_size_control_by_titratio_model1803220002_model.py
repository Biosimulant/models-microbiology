...
"""Auto-generated SBML BioModule wrapper for Heldt2018 - Budding yeast size control by titration of nuclear sites.

Source: biomodels_ebi:MODEL1803220002
Original: https://www.ebi.ac.uk/biomodels/MODEL1803220002
"""
...
class SbmlHeldt2018BuddingYeastSizeControlByTitrationOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Heldt2018 - Budding yeast size control by titration of nuclear sites."""

    def __init__(self, model_path: str = "data/MODEL1803220002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Heldt2018BuddingYeastSizeControlByTitratioModel1803220002Model = SbmlHeldt2018BuddingYeastSizeControlByTitrationOf
