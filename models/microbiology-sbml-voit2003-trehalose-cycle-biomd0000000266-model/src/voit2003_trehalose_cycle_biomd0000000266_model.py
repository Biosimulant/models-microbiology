...
"""Auto-generated SBML BioModule wrapper for Voit2003 - Trehalose Cycle.

Source: biomodels_ebi:BIOMD0000000266
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000266
"""
...
class SbmlVoit2003TrehaloseCycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Voit2003 - Trehalose Cycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000266.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Voit2003TrehaloseCycleBiomd0000000266Model = SbmlVoit2003TrehaloseCycle
