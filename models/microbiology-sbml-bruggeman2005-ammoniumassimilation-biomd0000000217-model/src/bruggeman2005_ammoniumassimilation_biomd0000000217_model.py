...
"""Auto-generated SBML BioModule wrapper for Bruggeman2005_AmmoniumAssimilation.

Source: biomodels_ebi:BIOMD0000000217
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000217
"""
...
class SbmlBruggeman2005Ammoniumassimilation(biosim.BioModule):
    """BioModule wrapper for SBML model: Bruggeman2005_AmmoniumAssimilation."""

    def __init__(self, model_path: str = "data/BIOMD0000000217.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bruggeman2005AmmoniumassimilationBiomd0000000217Model = SbmlBruggeman2005Ammoniumassimilation
