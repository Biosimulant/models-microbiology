...
"""Auto-generated SBML BioModule wrapper for Kaiser2014 - Salmonella persistence after ciprofloxacin treatment.

Source: biomodels_ebi:BIOMD0000000527
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000527
"""
...
class SbmlKaiser2014SalmonellaPersistenceAfterCiprofloxacin(biosim.BioModule):
    """BioModule wrapper for SBML model: Kaiser2014 - Salmonella persistence after ciprofloxacin treatment."""

    def __init__(self, model_path: str = "data/BIOMD0000000527.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kaiser2014SalmonellaPersistenceAfterCiprofloBiomd0000000527Model = SbmlKaiser2014SalmonellaPersistenceAfterCiprofloxacin
