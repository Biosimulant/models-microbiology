...
"""Auto-generated SBML BioModule wrapper for MODEL2426780967_url.xml.

Source: biomodels_ebi:MODEL2426780967
Original: https://www.ebi.ac.uk/biomodels/MODEL2426780967
"""
...
class SbmlModel2426780967UrlXml(biosim.BioModule):
    """BioModule wrapper for SBML model: MODEL2426780967_url.xml."""

    def __init__(self, model_path: str = "data/MODEL2426780967.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Model2426780967UrlXmlModel2426780967Model = SbmlModel2426780967UrlXml
