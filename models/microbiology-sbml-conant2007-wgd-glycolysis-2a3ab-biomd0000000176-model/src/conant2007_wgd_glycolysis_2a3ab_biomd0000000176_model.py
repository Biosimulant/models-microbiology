...
"""Auto-generated SBML BioModule wrapper for Conant2007_WGD_glycolysis_2A3AB.

Source: biomodels_ebi:BIOMD0000000176
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000176
"""
...
class SbmlConant2007WgdGlycolysis2a3ab(biosim.BioModule):
    """BioModule wrapper for SBML model: Conant2007_WGD_glycolysis_2A3AB."""

    def __init__(self, model_path: str = "data/BIOMD0000000176.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Conant2007WgdGlycolysis2a3abBiomd0000000176Model = SbmlConant2007WgdGlycolysis2a3ab
