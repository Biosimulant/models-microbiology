...
"""Auto-generated SBML BioModule wrapper for Liò2012_Modelling osteomyelitis_Control Model.

Source: biomodels_ebi:BIOMD0000000923
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000923
"""
...
class SbmlLio2012ModellingOsteomyelitisControlModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Liò2012_Modelling osteomyelitis_Control Model."""

    def __init__(self, model_path: str = "data/BIOMD0000000923.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Li2012ModellingOsteomyelitisControlModelBiomd0000000923Model = SbmlLio2012ModellingOsteomyelitisControlModel
