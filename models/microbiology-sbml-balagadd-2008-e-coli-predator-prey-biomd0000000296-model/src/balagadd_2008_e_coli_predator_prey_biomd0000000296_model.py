...
"""Auto-generated SBML BioModule wrapper for Balagaddé2008_E_coli_Predator_Prey.

Source: biomodels_ebi:BIOMD0000000296
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000296
"""
...
class SbmlBalagadde2008EColiPredatorPrey(biosim.BioModule):
    """BioModule wrapper for SBML model: Balagaddé2008_E_coli_Predator_Prey."""

    def __init__(self, model_path: str = "data/BIOMD0000000296.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Balagadd2008EColiPredatorPreyBiomd0000000296Model = SbmlBalagadde2008EColiPredatorPrey
