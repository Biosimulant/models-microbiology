...
"""Auto-generated SBML BioModule wrapper for Salcedo-Sora2016 - Microbial folate biosynthesis and utilisation.

Source: biomodels_ebi:BIOMD0000000725
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000725
"""
...
class SbmlSalcedoSora2016MicrobialFolateBiosynthesisAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Salcedo-Sora2016 - Microbial folate biosynthesis and utilisation."""

    def __init__(self, model_path: str = "data/BIOMD0000000725.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
SalcedoSora2016MicrobialFolateBiosynthesisABiomd0000000725Model = SbmlSalcedoSora2016MicrobialFolateBiosynthesisAnd
