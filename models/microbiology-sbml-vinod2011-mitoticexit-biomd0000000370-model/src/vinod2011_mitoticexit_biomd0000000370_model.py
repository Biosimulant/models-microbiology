...
"""Auto-generated SBML BioModule wrapper for Vinod2011_MitoticExit.

Source: biomodels_ebi:BIOMD0000000370
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000370
"""
...
class SbmlVinod2011Mitoticexit(biosim.BioModule):
    """BioModule wrapper for SBML model: Vinod2011_MitoticExit."""

    def __init__(self, model_path: str = "data/BIOMD0000000370.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Vinod2011MitoticexitBiomd0000000370Model = SbmlVinod2011Mitoticexit
