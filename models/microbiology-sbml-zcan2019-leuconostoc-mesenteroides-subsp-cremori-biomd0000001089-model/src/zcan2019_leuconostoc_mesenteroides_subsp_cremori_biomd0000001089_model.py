...
"""Auto-generated SBML BioModule wrapper for Özcan2019 - Leuconostoc mesenteroides subsp. cremoris (iLM.c559).

Source: biomodels_ebi:BIOMD0000001089
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001089
"""
...
class SbmlOzcan2019LeuconostocMesenteroidesSubspCremorisIlmC559(biosim.BioModule):
    """BioModule wrapper for SBML model: Özcan2019 - Leuconostoc mesenteroides subsp. cremoris (iLM.c559)."""

    def __init__(self, model_path: str = "data/BIOMD0000001089.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zcan2019LeuconostocMesenteroidesSubspCremoriBiomd0000001089Model = SbmlOzcan2019LeuconostocMesenteroidesSubspCremorisIlmC559
