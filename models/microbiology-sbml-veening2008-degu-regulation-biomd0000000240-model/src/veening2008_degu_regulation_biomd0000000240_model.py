...
"""Auto-generated SBML BioModule wrapper for Veening2008_DegU_Regulation.

Source: biomodels_ebi:BIOMD0000000240
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000240
"""
...
class SbmlVeening2008DeguRegulation(biosim.BioModule):
    """BioModule wrapper for SBML model: Veening2008_DegU_Regulation."""

    def __init__(self, model_path: str = "data/BIOMD0000000240.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Veening2008DeguRegulationBiomd0000000240Model = SbmlVeening2008DeguRegulation
