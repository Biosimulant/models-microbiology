...
"""Auto-generated SBML BioModule wrapper for Talemi2016 - Yeast osmo-homoestasis.

Source: biomodels_ebi:MODEL1606100000
Original: https://www.ebi.ac.uk/biomodels/MODEL1606100000
"""
...
class SbmlTalemi2016YeastOsmoHomoestasis(biosim.BioModule):
    """BioModule wrapper for SBML model: Talemi2016 - Yeast osmo-homoestasis."""

    def __init__(self, model_path: str = "data/MODEL1606100000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Talemi2016YeastOsmoHomoestasisModel1606100000Model = SbmlTalemi2016YeastOsmoHomoestasis
