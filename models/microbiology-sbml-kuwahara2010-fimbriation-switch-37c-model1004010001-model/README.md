...
**Source**: [biomodels_ebi](https://www.ebi.ac.uk/biomodels/MODEL1004010001)
**Standard**: sbml
**Authors**: Hiroyuki Kuwahara; Chris J Myers; Michael S Samoilov

## Description

This the detailed model for 37°C from the article: Temperature Control of Fimbriation Circuit Switch in Uropathogenic Escherichia coli : Quantitative Analysis via Automated Model Abstraction. Hiroyuki
