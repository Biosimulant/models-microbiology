...
"""Auto-generated SBML BioModule wrapper for Moriya2011_CellCycle_FissionYeast.

Source: biomodels_ebi:BIOMD0000000406
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000406
"""
...
class SbmlMoriya2011CellcycleFissionyeast(biosim.BioModule):
    """BioModule wrapper for SBML model: Moriya2011_CellCycle_FissionYeast."""

    def __init__(self, model_path: str = "data/BIOMD0000000406.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Moriya2011CellcycleFissionyeastBiomd0000000406Model = SbmlMoriya2011CellcycleFissionyeast
