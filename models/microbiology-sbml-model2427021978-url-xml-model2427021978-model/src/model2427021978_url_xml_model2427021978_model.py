...
"""Auto-generated SBML BioModule wrapper for MODEL2427021978_url.xml.

Source: biomodels_ebi:MODEL2427021978
Original: https://www.ebi.ac.uk/biomodels/MODEL2427021978
"""
...
class SbmlModel2427021978UrlXml(biosim.BioModule):
    """BioModule wrapper for SBML model: MODEL2427021978_url.xml."""

    def __init__(self, model_path: str = "data/MODEL2427021978.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Model2427021978UrlXmlModel2427021978Model = SbmlModel2427021978UrlXml
