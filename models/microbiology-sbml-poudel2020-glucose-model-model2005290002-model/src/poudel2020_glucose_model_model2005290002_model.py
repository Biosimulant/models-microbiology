...
"""Auto-generated SBML BioModule wrapper for Poudel2020 - Glucose Model.

Source: biomodels_ebi:MODEL2005290002
Original: https://www.ebi.ac.uk/biomodels/MODEL2005290002
"""
...
class SbmlPoudel2020GlucoseModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Poudel2020 - Glucose Model."""

    def __init__(self, model_path: str = "data/MODEL2005290002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Poudel2020GlucoseModelModel2005290002Model = SbmlPoudel2020GlucoseModel
