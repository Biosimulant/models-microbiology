...
"""Tellurium-backed SBML wrapper for Kuwahara2010_Fimbriation_Switch_37C."""
...
class Kuwahara2010fimbriationswitch37cmodel1004010001model(TelluriumSBMLBioModule):
    _SBML_ID = 'MODEL1004010001'
    _TITLE = 'Kuwahara2010_Fimbriation_Switch_37C'
    ...
    _PARAMETER_INPUTS = {}
    _INITIAL_CONDITION_INPUTS = {'initial_fime_site_recombinase': ('FimE', 31.0, 'native SBML value', 'Initial FimE site-recombinase level from the bundled SBML source.'), 'initial_fimb_site_recombinase': ('FimB', 100.0, 'native SBML value', 'Initial FimB site-recombinase level from the bundled SBML source.')}
    ...
    def __init__(self, model_path: str = 'data/MODEL1004010001.xml', integration_step: float = 1.0) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


Kuwahara2010FimbriationSwitch37cModel1004010001Model = Kuwahara2010fimbriationswitch37cmodel1004010001model
