...
"""Tellurium-backed SBML wrapper for Budding yeast size control by titration of nuclear sites."""
...
class Buddingyeastsizecontrolbytitrationofnuclebiomd0000000856model(TelluriumSBMLBioModule):
    _SBML_ID = 'BIOMD0000000856'
    _TITLE = 'Budding yeast size control by titration of nuclear sites'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000856.xml', integration_step: float = 1.0) -> None:
        super().__init__(model_path=model_path, integration_step=integration_step)


BuddingYeastSizeControlByTitrationOfNucleBiomd0000000856Model = Buddingyeastsizecontrolbytitrationofnuclebiomd0000000856model
